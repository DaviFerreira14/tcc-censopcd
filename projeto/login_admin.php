...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($cpf) || empty($senha)) {
        ...
        // Verificar se é o CPF e senha específicos para redirecionar para 'gerenciar_reclamacao.php'
        if ($cpf === '12345678900' && $senha === 'adm') {
            ...
            error_log("Redirecionando para gerenciar_reclamacao.php com CPF: $cpf");

            header("Location: gerenciar_reclamacao.php"); // Redirecionar para a página de gerenciamento de reclamações
            exit();
        }

        // Consulta para obter o ID do usuário e a senha criptografada
...
<head>
    ...
    <title>Login Administrador - CensoPCD+</title>
...
<div class="login-container" style="margin-top: 80px;">
    ...
    <p class="admin-link">Login para usuário? <a href="index.php">Clique aqui</a>.</p>
